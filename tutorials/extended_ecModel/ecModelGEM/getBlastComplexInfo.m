function blastFakeComplexInfo = getBlastComplexInfo(blastStructure, minAligLen, complexInfo, modelAdapter)
% getBlastComplexInfo
...
% Usage:
%  blastFakeComplexInfo = getBlastComplexInfo(blastStructure, minAligLen,
...
for i = 1:numel(blastStructure)
    indexes = blastStructure(i).aligLen >= minAligLen;
...
%Adding stochiometry and other info from complexInfo
...
for i=1:numel(filteredBlastStructure)
    ...
    for j=1:numel(complexData)
        ...
        %If no match is found, keep initialized values
