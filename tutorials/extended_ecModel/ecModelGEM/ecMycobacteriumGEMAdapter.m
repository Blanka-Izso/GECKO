classdef ecMycobacteriumGEMAdapter < ModelAdapter
    methods
        function obj = ecMycobacteriumGEMAdapter()
            ...
            obj.params.path = fullfile(findGECKOroot, 'tutorials', 'extended_ecModel', 'ecModelGEM');

			% Path to the conventional GEM that this ecModel will be based on.
			obj.params.convGEM = fullfile(obj.params.path,'models','iEK1008.xml');
            ...
            % when calling getComplexData(0) it downloads everything
            ...
            %%proteome
            obj.params.uniprot.type = ''; % 'proteome' or 'taxonomy'
            %%UP000001584
			obj.params.uniprot.ID = ''; % should match the ID type
            ...
            %%gene_oln is the output field for ordered locus which is
            %%basically the orf but it's not called orf in the output 
